...
export default function HistoryPage() {
  ...
  const handleDownloadPDF = () => {
    const doc = new jsPDF();
    const brandColor = [139, 92, 246]; // Tailwind purple-500
    
    doc.setFont("helvetica", "bold");
    doc.setFontSize(20);
    doc.text("BikeCare Tracker - Rides Report", 14, 20);
    ...
    if (user && user.email) {
      doc.text(`Rider Account: ${user.email}`, 14, 34);
    }
    ...
    doc.autoTable({
      ...
      startY: 40,
      theme: "grid",
      headStyles: { fillColor: brandColor, textColor: 255, halign: 'left' },
    ...
    doc.save("bikecare_rides_report.pdf");
  };
